...
AppDev.js
Author: Derek Jeong
Description: AppDev.js is a react hook component for rendering Web Development page of the official webwizrd site.
*/
...
// images
import homeIcon from "../img/services/home.png";
	...
	<div className="Services">
		...
		>
			<Grid item xs={window.innerWidth > 760 ? 6 : 12} style={{textAlign: window.innerWidth > 760 ? "left" : "center"}}>
				<h2 className="header">App Development</h2>
				<h4>Get your own app</h4>
				<p>We can conjure you up a one-of-a-kind app. Service includes design of wireframe, development, 
                    deployment, and life-time maintenance. Contact us, today, to schedule a consultation.</p>
